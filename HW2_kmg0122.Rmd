...
```{r}
data.q<-quantile(fit.diags$.fitted, probs<-seq(0,1,length.out=length(fit.diags$.fitted)))
norm<-qnorm(probs, lower.tail = TRUE, log.p = FALSE)
plot(norm,probs, xlab="Theoritical Qunatiles", ylab="Sample Qunatiles", main = "Normal Q-Q plot")
```
